...
class RegistrationForm(FlaskForm):
    ...
    # WTForms will use these functions and will only validate the username and email chosen by
...
class UpdateAccountForm(FlaskForm):
    ...
    def validate_email(self, email):
        # only throw an error if email changed and the new one is already in the db
